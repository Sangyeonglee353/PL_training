...
class testCylinder(): # Defining the testCylinder function
    ...
    print(isinstance(cy1, Cylinder)) # object of subclass is are also super class?
    print(isinstance(cy1, Circle))
    c2 = Circle()
    print(isinstance(c2, Cylinder))
    print(Cylinder.__base__)
    print(Circle.__subclasses__()) #list of subclass
